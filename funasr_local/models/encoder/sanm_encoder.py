...
from funasr_local.modules.attention import MultiHeadedAttention, MultiHeadedAttentionSANM, MultiHeadedAttentionSANMwithMask
from funasr_local.modules.embedding import SinusoidalPositionEncoder, StreamSinusoidalPositionEncoder
...
from funasr_local.modules.mask import subsequent_mask, vad_mask
...
class SANMEncoder(AbsEncoder):
    ...
    def forward(
        ...
        intermediate_outs = [xs_pad.clone()]
