...
from funasr_local.models.e2e_asr_common import ErrorCalculator
...
from funasr_local.modules.streaming_utils.chunk_utilis import sequence_mask
...
class UniASR(AbsESPnetModel):
    ...
    def __init__(
        ...
        if self.encoder.overlap_chunk_cls is not None:
            from funasr_local.modules.streaming_utils.chunk_utilis import build_scama_mask_for_cross_attention_decoder
